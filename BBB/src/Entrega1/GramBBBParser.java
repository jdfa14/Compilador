	...
	public final InstructionsContext instructions() throws RecognitionException {
		...
		try {
			...
			case COL:
				...
				match(OP);
				setState(354);
				CompiAPI.INSTRUCTIONS.ins3(getCurrentToken().getText());match(CTEI);
				setState(355);
				match(COM);
				setState(356);
				CompiAPI.INSTRUCTIONS.ins4(getCurrentToken().getText());match(CTEI);
				setState(357);
				match(COM);
				setState(358);
				CompiAPI.INSTRUCTIONS.ins5(getCurrentToken().getText());match(CTEI);
				setState(359);
				match(CP);
				}
				break;
			case MOV:
				...
				match(OP);
				setState(362);
				CompiAPI.INSTRUCTIONS.ins6(getCurrentToken().getText());match(CTEI);
				setState(363);
				match(COM);
				setState(364);
				CompiAPI.INSTRUCTIONS.ins7(getCurrentToken().getText());match(CTEI);
				setState(365);
				match(CP);
				}
				break;
	...
	public final MultidimvContext multidimv() throws RecognitionException {
		...
		try {
			...
			case OB:
				...
				{
				setState(456);
				match(OB);CompiAPI.VAR.ins4();
				setState(457);
				dimv();
				setState(458);
				match(CB);CompiAPI.VAR.ins6();
				}
				break;
			default:
				throw new NoViableAltException(this);
